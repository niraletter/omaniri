...
Item {
  ...
  readonly property string helperPath: (omaniriPath || "") + "/shell/plugins/panels/dropbox/status.py"
  ...
  function openFile(file) {
    ...
    Quickshell.execDetached(["nautilus", "--select", fileUri(String(file.path))])
  }
