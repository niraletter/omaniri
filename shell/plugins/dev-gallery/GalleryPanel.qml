...
// Visual reference + live playground for omaniri-shell's common UI
// components. Summon with `omaniri dev ui-preview`, or directly via:
//   omaniri-shell shell summon omaniri.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `omaniri dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("omaniri.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Omaniri shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("omaniri.dev-gallery")
    }
      ...
      PanelKeyCatcher {
        ...
        Column {
          ...
          Column {
            ...
            Text {
              text: "Omaniri shell · dev gallery"
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `omaniri font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["omaniri.clock", "omaniri.weather", "omaniri.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "omaniri.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "omaniri-menu", label: "Omaniri menu", description: "Launcher / system menu" },
