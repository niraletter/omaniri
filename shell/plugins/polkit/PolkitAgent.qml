...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "omaniri-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("omaniri polkit agent registered")
      else console.warn("omaniri polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omaniri-polkit"
