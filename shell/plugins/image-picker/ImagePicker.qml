...
Item {
  ...
  // Injected by omaniri-shell; defaults to the session OMANIRI_PATH.
  property string omaniriPath: Quickshell.env("OMANIRI_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("OMANIRI_IMAGE_SELECTOR_DIRS") || Quickshell.env("OMANIRI_IMAGE_SELECTOR_DIR") || Quickshell.env("OMANIRI_STOCK_BACKGROUNDS_DIR") || (stateHome + "/omaniri/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("OMANIRI_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("OMANIRI_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("OMANIRI_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return omaniriPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by omaniri-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omaniri-image-selector"
