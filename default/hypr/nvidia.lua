...
local nvidia = paths.omaniri_path .. "/bin/omaniri-hw-nvidia"
local nvidia_gsp = paths.omaniri_path .. "/bin/omaniri-hw-nvidia-gsp"
local nvidia_without_gsp = paths.omaniri_path .. "/bin/omaniri-hw-nvidia-without-gsp"
