...
-- layer-shell surfaces such as Omaniri panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "omaniri-shell shell toggle omaniri.clipboard")
