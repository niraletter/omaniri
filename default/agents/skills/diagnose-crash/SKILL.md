...
description: >
  ...
  Covers reporting a confirmed Omaniri bug upstream — see reporting.md.
---
...
## If it is an Omaniri bug

Most application crashes are upstream bugs in those applications, not Omaniri's
doing. In the minority of cases where the cause really does sit within Omaniri's
