--
-- Dynamic omaniri Theme Menu for Elephant/Walker
--
Name = "omanirithemes"
NamePretty = "omaniri Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omaniri/themes"
  local OMANIRI_PATH = os.getenv("OMANIRI_PATH") or ""
  local default_theme_dir = OMANIRI_PATH .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omaniri-theme-set " .. theme_name,
            },
          })
        end
      end
