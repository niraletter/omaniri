notify_update() {
  omaniri-notification-send -u critical -g  "Update System" "Click to update the system." \
    --exec "omaniri-launch-floating-terminal-with-presentation omaniri-update"
}

notify_wifi() {
  omaniri-notification-send -u critical -g 󰖩 "Setup Wi-Fi" "Click to configure the wireless network." \
    --exec "omaniri-shell shell toggle omaniri.network"
}
