if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/OMANIRI_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $OMANIRI_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $OMANIRI_PATH/default/snapper/root /etc/snapper/configs/root
